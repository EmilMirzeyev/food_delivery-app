...
class UiConstraints {
  ...
  TextStyle get px11w500k617282 => const TextStyle(fontSize: 11, fontWeight: FontWeight.w500, color: Color(0xff617282));
  TextStyle get px12w500k617282 => const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xff617282));
